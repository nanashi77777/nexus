...
exported at 2025-07-18 15:24:27
...
| name        | value   | required | desc                                                                                   |
|-------------|---------|----------|----------------------------------------------------------------------------------------|
| accessLevel | PRIVATE | YES      | 访问级别 (PUBLIC, PRIVATE) PRIVATE :私有的<br>只有所有者或被明确授权的用户才能访问。<br>PUBLIC :公开的<br>任何人都可以访问。 |
...
**Path:** /api/v1/common/file/{fileId}
